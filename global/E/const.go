...
const (
	...
	// 操作类型 BussinessType
	BusinessTypeOther = "0" //其他,即查询
	BusinessTypeAdd   = "1" //新增
	BusinessTypeEdit  = "2" //编辑
	BusinessTypeDel   = "3" //删除
	...
	UserMenu     = "user_menu"     //用户菜单
	UserRole     = "user_role"     //用户角色

	// 缓存公共KEY(SystemBase下的公共Key)
	SystemMenu    = "system_menu"    //系统菜单
	SystemRole    = "system_role"    //系统角色
	SystemMonitor = "system_monitor" //系统监控
